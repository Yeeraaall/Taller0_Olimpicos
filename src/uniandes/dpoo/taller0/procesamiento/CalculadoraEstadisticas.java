...
public class CalculadoraEstadisticas
{
	...
	/*
	 * Busca el nombre de un atleta dado por el usuario y retorna el nombre del país al que representa
	 */
	
	public String PaisPorAtleta (String nombreAtleta)
	{
		for (Atleta elAtleta: atletas)
		{
			if (elAtleta.getNombre().equals(nombreAtleta))
			{
				Pais elPais = elAtleta.getPais();
				return elPais.getNombre();
			}
		}
		return "0";
	 }
