...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		/**
		 * Creación opción taller 1- OLimpicos 
		 */
	...
	/**
	 * Ejecuta la opción de consultar el país de un atleta dado por el usuario.
	 * Modificación de archivo taller 1- Olimpicos
	 */
	private void ejecutarPaisPorAtleta()
	{

		System.out.println("\n" + "Pais que representa el atleta"  ) ;
		String nameAtleta = input ("Por favor ingrese el nombre de un atleta: ").toLowerCase();
		
		String respuesta = calculadora.PaisPorAtleta(nameAtleta);
		
		if ( !respuesta.equals("0") )
		{
			System.out.println("El país al que representa " + nameAtleta + " es " + respuesta );
		}
		else
		{
